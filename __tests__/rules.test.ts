...
// NOTE: In an actual production app, I would have a lot more tests. This covers edges cases and some basic functionality.
...
it('two pair, hightest pair match, highest low pair wins', () => {
  let hands =
  [ 
    [cft('K', Suite.SPADES),   cft('K', Suite.DIAMONDS), cft('Q', Suite.SPADES),   cft('Q', Suite.HEARTS),   cft('8', Suite.HEARTS)],
    [cft('K', Suite.CLUBS),    cft('K', Suite.HEARTS),   cft('J', Suite.DIAMONDS), cft('J', Suite.CLUBS),    cft('8', Suite.SPADES)],
    [cft('A', Suite.DIAMONDS), cft('K', Suite.DIAMONDS), cft('4', Suite.DIAMONDS), cft('5', Suite.DIAMONDS), cft('7', Suite.CLUBS)],
    [cft('A', Suite.CLUBS),    cft('K', Suite.CLUBS),    cft('3', Suite.CLUBS),    cft('9', Suite.CLUBS),    cft('8', Suite.DIAMONDS)] 
  ];
  const winners = rules.findWinners(hands);
  expect(winners).toStrictEqual([1]);
})

it('two pair, hightest pair match, lowest pair match, high card wins', () => {
  let hands =
  [ 
    [cft('K', Suite.SPADES),   cft('K', Suite.DIAMONDS), cft('Q', Suite.SPADES),   cft('Q', Suite.HEARTS),   cft('5', Suite.HEARTS)],
    [cft('K', Suite.CLUBS),    cft('K', Suite.HEARTS),   cft('Q', Suite.DIAMONDS), cft('Q', Suite.CLUBS),    cft('8', Suite.SPADES)],
    [cft('A', Suite.DIAMONDS), cft('K', Suite.DIAMONDS), cft('4', Suite.DIAMONDS), cft('5', Suite.DIAMONDS), cft('7', Suite.CLUBS)],
    [cft('A', Suite.CLUBS),    cft('K', Suite.CLUBS),    cft('3', Suite.CLUBS),    cft('9', Suite.CLUBS),    cft('8', Suite.DIAMONDS)] 
  ];
  const winners = rules.findWinners(hands);
